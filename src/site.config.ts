// TODO: uzupełnić przed publikacją — to samo, o co proszę w src/site.config.ts w repo
// petytor/jawna-sprawa (sekcja "O mnie" na tej stronie i stopka tamtego szablonu powinny
// być spójne).
export const tworca = {
  nazwa: 'TODO',
